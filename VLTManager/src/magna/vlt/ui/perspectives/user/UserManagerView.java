...
public class UserManagerView extends ViewPart {
	...
	private void initProject() {
		String query = "select a.id, b.name as companyname, a.ownerid from project a, company b where a.companyid = b.id and a.isopen = 0";
		Hashtable<Integer, String> table = initializer.getTripledList(query, "id", "companyname", "ownerid");
