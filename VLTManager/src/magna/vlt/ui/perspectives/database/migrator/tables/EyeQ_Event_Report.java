...
public class EyeQ_Event_Report extends Migrator{

	private String eventCategoryId;
	public EyeQ_Event_Report(Composite parent, Map map, String tableNameInLegacyDB, String tableNameInNewDB, String projectid, String eventCategoryId) {
		super(parent, "EyeQ_Event_Report", map, tableNameInLegacyDB, tableNameInNewDB, projectid);
	...
	protected void addNewField(Hashtable<String, Vector<String>> data)
	{
		...
		addData(data, "predefinedannotationid", "0");
	}
	...
	{
		selectQuery = "select reportid, vin, clipid, conv(eventid, 10, 16) eventid, eventstatus, localpctime, eventadtftime, userannotation, gpslongitude, gpslatitude from eyeq_event_report";
